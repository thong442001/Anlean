            ...
            <Svg height={height} width="400">
                <Defs>
                    <LinearGradient id="grad" x1="0" y1="0" x2="1" y2="0">
                        <Stop offset="0" stopColor="#BA872C" stopOpacity="1" />
                        <Stop offset="0.15" stopColor="#E8E276" stopOpacity="1" />
                        <Stop offset="0.85" stopColor="#E1D770" stopOpacity="1" />
                        <Stop offset="1" stopColor="#885021" stopOpacity="1" />
                    </LinearGradient>
                </Defs>
                <Text
